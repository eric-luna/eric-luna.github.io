$(document).ready(function(){
	...
	$(window).scroll(function() {
		...
		if ($(document).scrollTop() > 0 && $(document).scrollTop() < ($(".html5").offset().top-65)) {
		...
		if ($(document).scrollTop() > ($(".html5").offset().top-65) && $(document).scrollTop() < $(".responsive").offset().top-65) {
		...
		if ($(document).scrollTop() > ($(".responsive").offset().top-65) && $(document).scrollTop() < ($(".javascript").offset().top)-65) {
		...
		if ($(document).scrollTop() > ($(".javascript").offset().top-65) && $(document).scrollTop() < ($("#projects").offset().top)-65) {
